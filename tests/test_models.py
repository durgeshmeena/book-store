...
def test_create_member():
    member = Member(
        name="testuser", email="test@example.com", password="password", username="testuser", admin=False, active=False
    )
...
def test_create_book():
    book = Book(
                ...
                authors=["Author 1"], average_rating=4.5,
                isbn="1234567890123", isbn13="9781234567890", language_code="en",
                num_pages=300, ratings_count=100, text_reviews_count=10,
                publication_date="2023-01-01", publisher="Test Publisher"
            )
